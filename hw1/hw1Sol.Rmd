...
The first command with ">" will overwrite the original content in test1.txt with 'hello, world';
whereas the second command with ">>" will add 'hello, world' to the original content in test2.txt.
